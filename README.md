...
```json
"depencies": {
  "@whiskeysockets/baileys": "github:arullofficial/baileys"
}
```
## Import
```javascript
...
await client.sendMessage(m.chat, {
  pollResultMessage: {
    ...
    newsletter: {
      newsletterName: "Арул Цзи Шторм ( 404 )",
...
await client.relayMessage(m.chat, {
  productMessage {
    ...
    buttons: [
      {
        name: "cta_url",
        buttonParamsJson: "{\"display_text\":\"Арул Цзи Шторм ( 404 )\",\"url\":\"https://t.me/arulofficialll\"}"
      }
    ],
