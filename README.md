...
await sock.sendMessage(jid, { 
    eventMessage: { 
        ...
        joinLink: "https://call.whatsapp.com/video/arulofficialll", 
...
await sock.sendMessage(jid, {
    interactiveMessage: {
        header: "Hello World",
        title: "Hello World",
        footer: "telegram: @arulofficialll ",
        buttons: [
            {
                name: "cta_copy",
        ...
        nativeFlowMessage: {        
            messageParamsJson: JSON.stringify({          
                ...
                tap_target_configuration: {            
                    ...
                    canonical_url: "https://t.me/arulofficialll",            
...
await sock.sendMessage(jid, {
    interactiveMessage: {
        ...
        externalAdReply: {
            ...
            mediaUrl: " X ",
            sourceUrl: "https://t.me/arulofficialll",
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/arulofficialll",
                    merchant_url: "https://t.me/arulofficialll"
                })
            }
        ]
    }
